...
export const COUNTRIES = [
  ...
  },
  {
    ...
    stops: ['Essaouira', 'Agadir', 'Taghazout', 'Chefchaouen', 'Marrakech', 'Tangier', 'Merzouga'],
    tables: [
  ...
  {
    id: 'egypt', name: 'Egypt', flag: '🇪🇬', backdrop: 'dubai',
    ...
    stops: ['Sharm El Sheikh', 'Dahab', 'Hurghada', 'Marsa Alam', 'Siwa', 'Nuweiba', 'Ras Mohammed'],
    tables: [
  ...
  },
  {
    ...
    stops: ['Hvar', 'Dubrovnik', 'Split', 'Korčula', 'Brač', 'Rovinj', 'Vis'],
    tables: [
...
const FLICKS = [8, 20, 34, 19, 37, 35, 40];
...
export function buildCountryLevels() {
  ...
  COUNTRIES.forEach((c, ci) => {
    for (let i = 0; i < STOPS_PER_TOUR; i++) {
      ...
      if (HAZARDS[mech] && HAZARDS[mech].tide && GOALS[i] < 7) {
